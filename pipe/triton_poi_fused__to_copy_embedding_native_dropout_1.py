...
@triton.jit
def triton_poi_fused__to_copy_embedding_native_dropout_1(in_ptr0, in_ptr1, in_ptr2, out_ptr1, out_ptr2, load_seed_offset, xnumel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 4194304
    ...
    for r in tl.range(0, XBLOCK, R0_BLOCK, num_stages=2):
        ...
        tmp7 = tl.full([R0_BLOCK], 32000, tl.int32)
        tmp8 = tmp6 + tmp7
        tmp9 = tmp6 < 0

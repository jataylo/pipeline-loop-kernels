...
def get_args():
    arg_0 = rand_strided((30000,), (1,), device='cuda:0', dtype=torch.float32)
    arg_1 = rand_strided((30000,), (1,), device='cuda:0', dtype=torch.float16)
    return arg_0, arg_1, 30000,
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused__to_copy_22.run(*args, stream=stream0)


def benchmark_all_configs(args):
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        return triton_poi_fused__to_copy_22.benchmark_all_configs(*args)

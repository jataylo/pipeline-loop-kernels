...
@triton.jit
def triton_poi_fused__to_copy_addmm_clone_im2col_transpose_unsqueeze_view_12(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 1769472

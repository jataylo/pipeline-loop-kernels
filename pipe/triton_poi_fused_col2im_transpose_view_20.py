...
@triton.jit
def triton_poi_fused_col2im_transpose_view_20(in_ptr0, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ynumel = 3456
    xnumel = 512

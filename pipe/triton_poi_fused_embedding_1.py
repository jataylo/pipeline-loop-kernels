...
def triton_poi_fused_embedding_1(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r in tl.range(0, XBLOCK, R0_BLOCK, num_stages=2):
        ...
        tmp1 = tl.full([R0_BLOCK], 1026, tl.int32)
        tmp2 = tmp0 + tmp1
        tmp3 = tmp0 < 0

...
def triton_poi_fused__to_copy_add_embedding_index_select_mul_native_dropout_ne_view_4(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, out_ptr2, load_seed_offset, xnumel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r in tl.range(0, XBLOCK, R0_BLOCK, num_stages=2):
        ...
        tmp7 = tl.full([R0_BLOCK], 128112, tl.int32)
        tmp8 = tmp6 + tmp7
        tmp9 = tmp6 < 0
        ...
        tmp24 = tmp23 + tmp19
        tmp25 = tl.full([R0_BLOCK], 1026, tl.int32)
        tmp26 = tmp24 + tmp25
        tmp27 = tmp24 < 0
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused__to_copy_add_embedding_index_select_mul_native_dropout_ne_view_4.run(*args, stream=stream0)


def benchmark_all_configs(args):
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        return triton_poi_fused__to_copy_add_embedding_index_select_mul_native_dropout_ne_view_4.benchmark_all_configs(*args)

...
@triton.jit
def triton_poi_fused__to_copy_add_embedding_index_select_mul_ne_view_4(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 131072

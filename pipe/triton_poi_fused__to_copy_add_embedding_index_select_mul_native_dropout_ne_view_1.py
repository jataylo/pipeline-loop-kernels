...
@triton.jit
def triton_poi_fused__to_copy_add_embedding_index_select_mul_native_dropout_ne_view_1(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, out_ptr2, load_seed_offset, xnumel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 2097152

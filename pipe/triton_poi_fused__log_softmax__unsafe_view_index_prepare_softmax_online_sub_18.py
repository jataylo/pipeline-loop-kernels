...
@triton.jit
def triton_poi_fused__log_softmax__unsafe_view_index_prepare_softmax_online_sub_18(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 8

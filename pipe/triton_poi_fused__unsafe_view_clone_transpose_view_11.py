...
@triton.jit
def triton_poi_fused__unsafe_view_clone_transpose_view_11(in_ptr0, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ynumel = 1024
    xnumel = 1024

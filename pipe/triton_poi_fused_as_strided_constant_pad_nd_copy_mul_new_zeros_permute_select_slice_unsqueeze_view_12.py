...
@triton.jit
def triton_poi_fused_as_strided_constant_pad_nd_copy_mul_new_zeros_permute_select_slice_unsqueeze_view_12(in_ptr0, in_ptr1, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ynumel = 4096
    xnumel = 513
    ...
    for r in tl.range(0, YBLOCK, R0_BLOCK, num_stages=2):
        ...
        tmp22 = tl.broadcast_to(x3, [R0_BLOCK, XBLOCK])
        ...
        tmp48 = tl.broadcast_to(x3, [R0_BLOCK, XBLOCK])

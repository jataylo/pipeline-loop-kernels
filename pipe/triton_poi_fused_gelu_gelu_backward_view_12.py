...
@triton.jit
def triton_poi_fused_gelu_gelu_backward_view_12(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 524288
...
def get_args():
    arg_0 = rand_strided((1, 512, 1024), (524288, 1024, 1), device='cuda:0', dtype=torch.float16)

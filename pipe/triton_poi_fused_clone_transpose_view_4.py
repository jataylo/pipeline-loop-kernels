...
def get_args():
    arg_0 = rand_strided((6, 128, 64), (8192, 64, 1), device='cuda:0', dtype=torch.float16)
    arg_1 = rand_strided((1, 128, 6, 64), (49152, 384, 64, 1), device='cuda:0', dtype=torch.float16)
    return arg_0, arg_1, 49152,
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_clone_transpose_view_4.run(*args, stream=stream0)


def benchmark_all_configs(args):
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        return triton_poi_fused_clone_transpose_view_4.benchmark_all_configs(*args)

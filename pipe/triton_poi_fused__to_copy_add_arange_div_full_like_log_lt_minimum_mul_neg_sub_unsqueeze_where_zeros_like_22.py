...
@triton.jit
def triton_poi_fused__to_copy_add_arange_div_full_like_log_lt_minimum_mul_neg_sub_unsqueeze_where_zeros_like_22(out_ptr0, xnumel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 16384

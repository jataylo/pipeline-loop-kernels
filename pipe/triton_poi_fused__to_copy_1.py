...
@triton.jit
def triton_poi_fused__to_copy_1(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 262144
...
def get_args():
    ...
    arg_1 = rand_strided((1, 256, 1024), (262144, 1024, 1), device='cuda:0', dtype=torch.float16)

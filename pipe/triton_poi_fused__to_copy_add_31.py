...
def get_args():
    arg_0 = rand_strided((16384, 4096), (4096, 1), device='cuda:0', dtype=torch.float32)
    arg_1 = rand_strided((16384, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    arg_2 = rand_strided((16384, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    arg_3 = rand_strided((16384, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    arg_4 = rand_strided((16384, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    arg_5 = rand_strided((16384, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    arg_6 = rand_strided((16384, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    arg_7 = rand_strided((16384, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    arg_8 = rand_strided((16384, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    arg_9 = rand_strided((16384, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    arg_10 = rand_strided((16384, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    arg_11 = rand_strided((16384, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
    arg_12 = rand_strided((16384, 4096), (4096, 1), device='cuda:0', dtype=torch.float16)
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused__to_copy_add_31.run(*args, stream=stream0)


def benchmark_all_configs(args):
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        return triton_poi_fused__to_copy_add_31.benchmark_all_configs(*args)

...
def get_args():
    ...
    arg_1 = rand_strided((128, 4, 128, 32), (16384, 4096, 32, 1), device='cuda:0', dtype=torch.float16)
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_clone_transpose_view_22.run(*args, stream=stream0)


def benchmark_all_configs(args):
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        return triton_poi_fused_clone_transpose_view_22.benchmark_all_configs(*args)

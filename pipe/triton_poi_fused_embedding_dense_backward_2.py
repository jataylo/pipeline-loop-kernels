...
def get_args():
    arg_0 = rand_strided((4098, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    return arg_0, 3147264,
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_embedding_dense_backward_2.run(*args, stream=stream0)


def benchmark_all_configs(args):
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        return triton_poi_fused_embedding_dense_backward_2.benchmark_all_configs(*args)

...
@triton.jit
def triton_poi_fused__to_copy_add_bmm_embedding_dense_backward_native_dropout_backward_nll_loss_forward_permute_squeeze_view_24(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, xnumel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 524288

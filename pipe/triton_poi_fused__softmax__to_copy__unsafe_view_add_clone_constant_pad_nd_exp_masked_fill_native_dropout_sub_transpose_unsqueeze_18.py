...
@triton.jit
def triton_poi_fused__softmax__to_copy__unsafe_view_add_clone_constant_pad_nd_exp_masked_fill_native_dropout_sub_transpose_unsqueeze_18(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, xnumel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 37847040

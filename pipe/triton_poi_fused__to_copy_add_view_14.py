...
def get_args():
    ...
    arg_2 = rand_strided((4096, 1024), (1024, 1), device='cuda:0', dtype=torch.float16)
    arg_3 = rand_strided((4096, 1024), (1024, 1), device='cuda:0', dtype=torch.float16)

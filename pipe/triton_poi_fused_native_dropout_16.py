...
@triton.jit
def triton_poi_fused_native_dropout_16(in_ptr0, out_ptr1, load_seed_offset, xnumel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 25214976

...
@triton.jit
def triton_poi_fused__to_copy__unsafe_view_add_mul_native_dropout_pow_tanh_12(in_ptr0, in_ptr1, in_ptr2, out_ptr1, out_ptr2, load_seed_offset, xnumel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 2097152

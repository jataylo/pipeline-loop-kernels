...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_as_strided_div_transpose_view_27.run(*args, stream=stream0)


def benchmark_all_configs(args):
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        return triton_poi_fused_as_strided_div_transpose_view_27.benchmark_all_configs(*args)

...
def get_args():
    arg_0 = rand_strided((1024, 1, 1024), (1024, 1024, 1), device='cuda:0', dtype=torch.float32)
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused__to_copy_bmm_permute_unsqueeze_view_10.run(*args, stream=stream0)


def benchmark_all_configs(args):
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        return triton_poi_fused__to_copy_bmm_permute_unsqueeze_view_10.benchmark_all_configs(*args)

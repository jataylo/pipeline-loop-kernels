...
@triton.jit
def triton_poi_fused_add_arange_bitwise_and_eq_expand_index_le_new_ones_scalar_tensor_unsqueeze_where_6(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 4194304
    ...
    for r in tl.range(0, XBLOCK, R0_BLOCK, num_stages=2):
        ...
        tmp4 = tmp3 & tmp2
        tmp5 = tl.full([R0_BLOCK], 512, tl.int32)
        tmp6 = tmp0 + tmp5
        tmp7 = tmp0 < 0

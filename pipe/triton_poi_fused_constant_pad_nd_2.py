...
def get_args():
    arg_0 = rand_strided((1, 2048), (2048, 1), device='cuda:0', dtype=torch.int64)
    arg_1 = rand_strided((1, 2049), (2064, 1), device='cuda:0', dtype=torch.int64)
    return arg_0, arg_1, 2049,
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_constant_pad_nd_2.run(*args, stream=stream0)


def benchmark_all_configs(args):
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        return triton_poi_fused_constant_pad_nd_2.benchmark_all_configs(*args)

...
def get_args():
    ...
    arg_1 = rand_strided((32, 256, 16, 64), (262144, 1024, 64, 1), device='cuda:0', dtype=torch.float16)
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_clone_transpose_5.run(*args, stream=stream0)


def benchmark_all_configs(args):
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        return triton_poi_fused_clone_transpose_5.benchmark_all_configs(*args)

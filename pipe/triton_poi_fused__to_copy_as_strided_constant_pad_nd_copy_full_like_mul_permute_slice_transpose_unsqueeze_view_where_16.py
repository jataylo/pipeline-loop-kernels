...
@triton.jit
def triton_poi_fused__to_copy_as_strided_constant_pad_nd_copy_full_like_mul_permute_slice_transpose_unsqueeze_view_where_16(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ynumel = 1024
    xnumel = 513
    ...
    for r in tl.range(0, YBLOCK, R0_BLOCK, num_stages=2):
        ...
        tmp12 = tl.broadcast_to(x1, [R0_BLOCK, XBLOCK])
        ...
        tmp40 = tl.broadcast_to(x1, [R0_BLOCK, XBLOCK])

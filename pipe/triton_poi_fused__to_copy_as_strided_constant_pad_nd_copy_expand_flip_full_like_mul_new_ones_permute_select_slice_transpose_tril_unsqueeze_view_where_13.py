...
@triton.jit
def triton_poi_fused__to_copy_as_strided_constant_pad_nd_copy_expand_flip_full_like_mul_new_ones_permute_select_slice_transpose_tril_unsqueeze_view_where_13(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ynumel = 1024
    xnumel = 513
    ...
    for r in tl.range(0, YBLOCK, R0_BLOCK, num_stages=2):
        ...
        tmp4 = tl.broadcast_to(x2, [R0_BLOCK, XBLOCK])
        ...
        tmp27 = tmp26 & tmp3
        tmp28 = tl.broadcast_to(x2, [R0_BLOCK, XBLOCK])
        ...
        tmp57 = tl.broadcast_to(x2, [R0_BLOCK, XBLOCK])
        ...
        tmp93 = tmp92 & tmp84
        tmp94 = tl.broadcast_to(x2, [R0_BLOCK, XBLOCK])

...
def get_args():
    arg_0 = rand_strided((1, 128, 1024), (131072, 1024, 1), device='cuda:0', dtype=torch.float16)
    arg_1 = rand_strided((128, 1024), (1024, 1), device='cuda:0', dtype=torch.float16)
    arg_2 = rand_strided((1, 128, 1024), (131072, 1024, 1), device='cuda:0', dtype=torch.bool)
    ...
    arg_5 = rand_strided((1, 128, 1024), (131072, 1024, 1), device='cuda:0', dtype=torch.float16)
    return arg_0, arg_1, arg_2, arg_3, arg_4, arg_5, 131072,
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused__to_copy__unsafe_view_add_mul_native_dropout_backward_pow_tanh_tanh_backward_view_5.run(*args, stream=stream0)


def benchmark_all_configs(args):
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        return triton_poi_fused__to_copy__unsafe_view_add_mul_native_dropout_backward_pow_tanh_tanh_backward_view_5.benchmark_all_configs(*args)

...
@triton.jit
def triton_poi_fused__to_copy_add_constant_pad_nd_embedding_dense_backward_nll_loss_forward_slice_slice_backward_view_26(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 16384

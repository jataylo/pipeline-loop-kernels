...
@triton.jit
def triton_poi_fused__to_copy__unsafe_view_add_mul_native_dropout_backward_pow_tanh_tanh_backward_view_6(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 2097152

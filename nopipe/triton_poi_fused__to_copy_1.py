...
def get_args():
    arg_0 = rand_strided((8008, 2560), (2560, 1), device='cuda:0', dtype=torch.float16)
    arg_1 = rand_strided((8008, 2560), (2560, 1), device='cuda:0', dtype=torch.float32)
    return arg_0, arg_1, 20500480,

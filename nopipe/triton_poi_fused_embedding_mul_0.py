...
def get_args():
    arg_0 = rand_strided((4, 128), (128, 1), device='cuda:0', dtype=torch.int64)
    arg_1 = rand_strided((8008, 2560), (2560, 1), device='cuda:0', dtype=torch.float32)
    arg_2 = rand_strided((4, 128, 2560), (327680, 2560, 1), device='cuda:0', dtype=torch.float32)
    return arg_0, arg_1, arg_2, 1310720,

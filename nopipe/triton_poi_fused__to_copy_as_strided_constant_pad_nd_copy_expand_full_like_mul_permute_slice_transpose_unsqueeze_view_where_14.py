...
@triton.jit
def triton_poi_fused__to_copy_as_strided_constant_pad_nd_copy_expand_full_like_mul_permute_slice_transpose_unsqueeze_view_where_14(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ynumel = 4096
    xnumel = 513
    ...
    tmp12 = tl.broadcast_to(x2, [YBLOCK, XBLOCK])
    ...
    tmp40 = tl.broadcast_to(x2, [YBLOCK, XBLOCK])

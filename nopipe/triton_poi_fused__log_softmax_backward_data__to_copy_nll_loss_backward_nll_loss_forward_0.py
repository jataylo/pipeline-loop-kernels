...
@triton.jit
def triton_poi_fused__log_softmax_backward_data__to_copy_nll_loss_backward_nll_loss_forward_0(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, xnumel, XBLOCK : tl.constexpr):
    xnumel = 2
